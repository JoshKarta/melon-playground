...
const PricingContainer = () => {
  ...
  const Heading = () => (
    <div className="relative z-0 mb-12 flex flex-col items-center justify-center gap-4">
  ...
  const PricingCards = () => (
    <div className="relative z-0 mx-auto flex w-full max-w-6xl flex-col gap-8 lg:flex-row lg:gap-4">
      {pricingPlans.map((plan, index) => (
        <div
          key={index}
          className="w-full rounded-xl border-[1px] border-gray-100 p-6 text-left dark:border-gray-600 bg-white shadow-sm hover:shadow transition-all duration-200"
        >
  ...
  return (
    <section className="relative w-full overflow-hidden">
      <div className="w-full dark:bg-black bg-white text-black lg:px-2 py-12 lg:py-24 dark:bg-grid-white/[0.2] bg-grid-black/[0.05] relative">
